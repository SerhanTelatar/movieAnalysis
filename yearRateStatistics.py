...
# Calculate statistics for each 5-year period
grouped_stats = []
for start_year in range(2000, 2024, 5):
    ...
    # Calculate adjusted R-squared
    n_period = len(period_df["Year"])  # Number of data points
    p_period = 1  # Number of predictors (in this case, it's 1, which is the "Year" feature)
